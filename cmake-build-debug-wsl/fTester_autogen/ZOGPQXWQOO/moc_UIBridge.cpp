...
#include "../../../src/UIBridge/UIBridge.h"
...
template <> constexpr inline auto UIBridge::qt_create_metaobjectdata<qt_meta_tag_ZN8UIBridgeE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Method 'startRender'
        QtMocHelpers::MethodData<void(int, int, bool)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 3 }, { QMetaType::Int, 4 }, { QMetaType::Bool, 5 },
        }}),
        // Method 'renderSingleFrame'
...
void UIBridge::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->startRender((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[3]))); break;
        case 1: _t->renderSingleFrame(); break;
        default: ;
        }
    }
}
